...
<head>
    ...
    <title>All Admins | Majesty Corporation LMS</title>
...
?>
                                    ...
                                    <tr>
                                        <td>
											<img width="28" height="28" src="../assets/img/account.png" class="rounded-circle" alt=""> <h2><?php echo $firstname . ' ' . $lastname ?></h2>
										</td>
                                        <td>S-000<?php echo $id; ?></td>
